...
const styles = {
    ...
    containerViewAlette_4img: css`
        ...
        height: 800px;
        flex: none;
        background: ${colors.rgbAlette.rgb1(1)} url(${imgs.$img9}) center center no-repeat;
    ...
    element_imput: css`
        ...
        height: 30px;
        outline: none;
        font-family: fontAeonikLight, aeonik_regular_2, sans-serif;
    ...
    return (
        <div css={styles.containerViewAlette_4}>
            ...
            <div css={styles.containerViewAlette4Lectura}>
                <h2 css={styles.viewAlette_4Title}> Solicitar tu tarjeta </h2>
                    ...
                    <form css={styles.mi_form}>
                        <div css={styles.conten_miform_alette}>
                            <div css={styles.conten_miform_alette_element}>
                                ...
                                <div css={styles.conten_alette_element}>
                                    <div css={styles.conten_alette_element_label_input}>
                                        <label htmlFor="textAletteNumber" css={styles.element_label}> Cédula </label>
                                    </div>
                                    <div css={styles.conten_alette_element_label_input}>
                                        <input css={styles.element_imput} type="tel" id="textAletteNumber" name="textAletteNumber" placeholder="Escribe aquí tu nombre." />
                                    </div>
                                </div>
