...
const styles = {
    containerFooter: css`
        ...
        height: auto;
        background-color: ${colors.rgbAlette.rgb5(1)};
        display: flex;
    ...
    containerFooterEmpresaContacto: css`
        ...
        flex: auto;
        border-left: solid 2px ${colors.rgbAlette.rgb18(1)};
    ...
    footerEmpresaContactoSpan: css`
        ...
        color: ${colors.rgbAlette.rgb18(1)};
        line-height: 30px;
    `,
            ...
            <div css={styles.containerFooterLogoDataContacto} > 
                ...
                <div css={styles.containerFooterEmpresa} >
                    <div css={styles.containerFooterEmpresaSpan}>
                        <span css={styles.footerEmpresaSpan}> Empresa Alette </span>
                    </div>
                    <div css={styles.containerFooterEmpresaContacto} >
                        <span css={styles.footerEmpresaContactoSpan}> Alette una empresa de Toribar </span>
                        <span css={styles.footerEmpresaContactoSpan}> Correo electronico: info@alette.com </span>
                        ...
                        <span css={styles.footerEmpresaContactoSpan}> Siguenos en las redes sociales: Alette </span>
                ...
                <div css={styles.containerFooterServicios} >
                    <div css={styles.containerFooterServiciosSpanTitle}>
                        <span css={styles.footerServiciosSpanTitle}> Servicios Alette </span>
                    </div>
                    <div css={styles.containerFooterServiciosSpan} >
                        <span css={styles.footerServiciosSpan}> Salas de belleza </span>
                        <span css={styles.footerServiciosSpan}> Spas </span>
                        <span css={styles.footerServiciosSpan}> Peluquerías </span>
                        <span css={styles.footerServiciosSpan}> Clinicas de esteticas </span>
                        <span css={styles.footerServiciosSpan}> Gimnasios </span>
                        <span css={styles.footerServiciosSpan}> Profesionales del cuidado personal </span>
                    </div>
                </div>
            </div>
            <div css={styles.containerfooterCorpringSpan} >
                <span css={styles.corpringSpan}> Copyright © 2019 - Alette | Desesarro web y Diseño gráfico >> Ghobbit. </span>
            </div>
        </div>
    )
}
