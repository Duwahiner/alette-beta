...
export const imgs = {
    $img1: '/images/portada.png',
    $img2: '/images/imgs01.png',
    $img3: '/images/imgs02.png',
    $img4: '/images/imgs03.png',
    $img5: '/images/imgs04.png',
    $img6: '/images/portada_alette.png',
    $img7: '/images/portada_services.png',
    $img8: '/images/portada_tarjeta.png',
    $img9: '/images/imgs05.png',
    $img10: '/images/imgs06.png',
    $img11: '/images/portada_contacto.png',
    $img12: '/images/portada_mujer.png',
}

export const svg = {
    logo: (name) => `/svg/${name}.svg`,
    svgIcons1: '/svg/iconos01.svg',
    svgIcons2: '/svg/menu_open.svg',
    svgIcons3: '/svg/iconos_services01.svg',
    servicesSvg1: '/svg/iconos_services01.svg',
    servicesSvg2: '/svg/iconos_services02.svg',
    servicesSvg3: '/svg/iconos_services03.svg',
    servicesSvg4: '/svg/iconos_services04.svg',
    servicesSvg5: '/svg/iconos_services05.svg',
    servicesSvg6: '/svg/iconos_services06.svg',
    beneficiosSvg1: '/svg/iconos_beneficios01.svg',
    beneficiosSvg2: '/svg/iconos_beneficios02.svg',
    beneficiosSvg3: '/svg/iconos_beneficios03.svg',
    beneficiosSvg4: '/svg/iconos_beneficios04.svg',
    beneficiosSvg5: '/svg/iconos_beneficios05.svg',
    menuOpen: '/svg/',
    menuClose: '/svg/',
    svgIconsRedes: ''
}